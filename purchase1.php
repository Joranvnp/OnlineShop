        ...
        <div class="row">
            <div class="col-md-3 login-form-1">
                ...
                <nav class="nav flex-column nav">
                    ...
                    <a class="nav-link active" href="">30 Tage Premium</a>
                </nav>
            </div>
            <div class="col-md-9 login-form-2">
                ...
                <form action="includes/purchase.inc.php" method="post">
                    ...
                    if (isset($_SESSION['userId'])) {
                        if (($guthaben >= 1000) && ($redeemable == "None") && ($rank == "Kein Rang")) {
                            echo '<div>
                            ...
                            echo '<button type="submit" class="btnSubmit" name="purchase-submit">Kaufen (1.000 <i class="fab fa-cuttlefish"></i>)
                            </button>';
                        } else {
                            if ($guthaben < 1000) {
                                echo '<button type="submit" class="btnSubmit" name="purchase-submit" disabled>Kaufen (1.000 <i class="fab fa-cuttlefish"></i> - Nicht genügend Guthaben)
                            </button>';
                            } else if ($redeemable == "OneMonth" || $rank == "Premium (1 Monat)") {
                                echo '<button type="submit" class="btnSubmit" name="purchase-submit" disabled>Kaufen (1.000 <i class="fab fa-cuttlefish"></i> - Rang bereits gekauft)
                            </button>';
                            } else if ($redeemable == "Lifetime" || $rank == "Premium (Lifetime)") {
                                echo '<button type="submit" class="btnSubmit" name="purchase-submit" disabled>Kaufen (1.000 <i class="fab fa-cuttlefish"></i> - Du besitzt bereits einen höheren Rang)
                            </button>';
                            }
                        }
                    }
